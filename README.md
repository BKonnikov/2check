...
`pnpm dev` поднимает внутренний веб-API на порту 3001 и веб-интерфейс на 3000. Откройте http://localhost:3000 и введите домен: сейчас работает категория DNS — сравнение четырёх резолверов, существование имени и согласованность ответов.
